...
<<<<<<< HEAD
  ...
  searchButton.addEventListener('click', async () => {
    ...
    if(weather.weather[0].main === "Clouds"){
      document.body.style.backgroundImage = "url('/image/cloudy-2680190_1920.jpg')"
    } else if(weather.weather[0].main === "Snow"){
      document.body.style.backgroundImage = "url('/image/snow.jpg')"
    }else if(weather.weather[0].main ==="Clear"){
      document.body.style.backgroundImage = "url('/image/sun-3588618_1920.jpg')"
    }else if(weather.weather[0].main === "Rain"){
      document.body.style.backgroundImage = "url('/image/pexels-rodrigo-souza-2531709.jpg')"
    }
  ...
  const getTime = () => {
    ...
    document.querySelector('.periode').innerHTML = `${AmPm}`
  }
...
>>>>>>> 5b703ea277a5212009d13c8a29961942932249a9
